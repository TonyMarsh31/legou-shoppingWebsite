...
public class MultiThreadingCreateOrder {
    ...
    public MultiThreadingCreateOrder(RedisTemplate redisTemplate, SeckillGoodsDao seckillGoodsDao, IdWorker idWorker, RedissonClient redissonClient) {
    ...
    public void createOrder() {
        ...
        //分布式锁
        RLock lock = redissonClient.getLock("seckill_lock_" + id);
        //同步创建的订单的方法
        try {
            //加锁
            // 参数1：等待锁的(最大)时间，参数2：持有锁的(最大)时间，参数3：时间单位
